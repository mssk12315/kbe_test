...
public:
	KBEEnvInit()
	{
		...
		setenv("KBE_RES_PATH", "E:/GIT/kbe_test/Debug;E:/KBE/kbengine-0.8.10/kbe/res;E:/KBE/kbengine-0.8.10/assets(minimum);E:/KBE/kbengine-0.8.10/assets(minimum)/res;E:/KBE/kbengine-0.8.10/assets(minimum)/script", 1);
